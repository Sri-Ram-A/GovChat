...
import { Loader2, Shield, ArrowRight, ArrowLeft, Check, ChevronsUpDown } from "lucide-react";
...
const STEPS = [
    { label: "Account credentials", desc: "Set up your secure GovChat access parameters." },
    { label: "Personal details", desc: "Provide your designation and organizational unit." },
];
...
export default function RegisterPage() {
    ...
    function handleNextStep(e?: React.MouseEvent<HTMLButtonElement>) {
        e?.preventDefault();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await REQUEST("POST", "handlers/register/", payload);
    ...
    return (
        <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-background p-4 sm:p-6 md:p-10">
            <div className="w-full max-w-100 flex flex-col gap-6">
                ...
                {/* GovChat Header Branding Block */}
                <div className="flex flex-col items-center gap-2 text-center">
                    <div className="flex h-10 w-10 items-center justify-center rounded-md border border-neutral-200 shadow-xs dark:border-neutral-800 bg-background text-neutral-950 dark:text-neutral-50">
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">
                        ...
                        <Link href="/handler/login" className="underline underline-offset-4 hover:text-neutral-900 dark:hover:text-neutral-50">
                            Sign in
                        </Link>
                    </p>
                </div>

                {/* Minimal Form Container Layout */}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {step === 1 && (
                                <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <Button
                                        type="button" /* Prevents accidental submission rules */
                                        onClick={(e)=>handleNextStep(e)}
                                        className="w-full bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-neutral-50 dark:hover:bg-neutral-200 dark:text-neutral-900 h-10 mt-2 transition-colors cursor-pointer flex items-center justify-center gap-2 font-medium text-sm"
                                    >
                                        Continue
